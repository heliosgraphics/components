...
const Toggle: React.FC<ToggleProps> = ({ id, isChecked, isDisabled, onChange, label }) => {
	const toggleId: string = getUUID(id);
	const toggleClasses = classNames(styles.toggle__toggle, "flex flex-y-center", {
		// "--checked": !!isChecked,
		// "--unchecked": !isChecked,
	...
	return (
		<div className={styles.toggle}>
			<label className={toggleClasses} htmlFor={toggleId}>
				<input type="checkbox" checked={isChecked} onChange={onToggle} id={toggleId} />
