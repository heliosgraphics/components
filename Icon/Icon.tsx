...
const Icon: React.FC<IconProps> = ({ name, className, size, color, isFullSize }) => {
	...
	const iconClasses: string = classNames(styles.icon, className, iconColor, "flex flex-center");
