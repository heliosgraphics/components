...
const Heading: React.FC<HeadingProps> = (props) => {
	const utility: string = getTypographyUtility({ ...props, className: styles.heading }, true);
	// TODO remvoe more
	const { level, textAlign, lineClamp, fontFamily, fontStyle, fontWeight, textDecoration, ...validProps } = props;
