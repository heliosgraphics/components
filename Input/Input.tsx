...
const Input: React.FC<InputProps> = (props) => {
	...
	const { helperText, isDisabled, isLabelHidden, isLoading, isRequired, results, ...goodProps } = props;

	const htmlFor: string = useMemo(() => getUUID(props.id), [props.id]);

	const inputClasses: string = classNames(styles.input, "flex flex-column flex-gap-3");
