...
const Checkbox: React.FC<CheckboxProps> = ({
	...
	const onToggle = (event: React.ChangeEvent<HTMLInputElement>) => onChange?.(event);

	return (
		<div className={styles.checkbox} role="checkbox" aria-checked={isChecked} aria-labelledby={id}>
