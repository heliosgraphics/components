...
const Select: React.FC<SelectProps> = ({ selectedValue, onChange, isLabelHidden, isDisabled, items, id, label }) => {
		...
		<Flex isColumn={true} gap={2} className={selectClasses}>
			...
			<Flex>
				...
				<Flex className={styles.select__icon} isCentered={true}>
					<Icon name="chevron-down" size={20} color={isDisabled ? "lightest-gray" : "light-gray"} />
				</Flex>
			</Flex>
		</Flex>
	);
