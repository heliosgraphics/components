	...
	return (
		<Dialog title={title} onClose={onCancel} isOpen={isOpen} isCentered={true}>
			<Flex gap={8} isColumn={true}>
				<ButtonGroup>
					<Button type="secondary" value={cancelText} onClick={onCancelClick} icon={cancelIcon} />
					<Button type="primary" color="red" value={confirmText} onClick={onConfirmClick} icon={confirmIcon} />
				</ButtonGroup>
				{!!details && (
